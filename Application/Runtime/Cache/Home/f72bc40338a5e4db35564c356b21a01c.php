    ...
    <div class="wrap">
      <div class="header">
        <div class="clearfix layout">
          ...
          <div><a href="/tp/index.php/Home/accountmanage/orgManage">账户管理</a><a href="/tp/index.php/Home/clientmanagege/clientList"class="active">客户管理</a><a href="/tp/index.php/Home/countmanage/countTable">结算管理</a><a href="/tp/index.php/Home/sysmanage/pwdManage">系统管理</a></div>
        </div>
      </div>
      <div class="main">
        <div class="sidebar"><a href="/tp/index.php/Home/clientmanage/clientList" >客户列表</a><a href="/tp/index.php/Home/clientmanage/chiCangSearch" class="active">持仓查询</a><a href="/tp/index.php/Home/clientmanage/pingCangSearch">平仓查询</a><a href="/tp/index.php/Home/clientmanage/chuRuJinSearch">出入金查询</a></div>
        <div class="content">
